    ...
    <section id="cta" data-testid="final-cta-section" className="relative py-28">
      <div className="max-w-7xl mx-auto px-5 md:px-8">
        <motion.div
          ...
          className={`relative rounded-[28px] overflow-hidden p-10 md:p-16 ${theme === "light"
        ...
        >
          ...
          <div className="absolute inset-0 -z-10">
            ...
            <div className={`absolute -top-40 -left-20 w-[500px] h-[500px] rounded-full blur-3xl ${theme === "light" ? "bg-blue-400/30" : "bg-blue-500/30"
              }`} />
            <div className={`absolute -bottom-40 -right-10 w-[560px] h-[560px] rounded-full blur-3xl ${theme === "light" ? "bg-purple-400/25" : "bg-purple-500/30"
              }`} />
            <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[420px] h-[420px] rounded-full blur-3xl ${theme === "light" ? "bg-cyan-400/20" : "bg-teal-400/20"
              }`} />
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-10 items-center">
            <div>
              {/* <div className={`inline-flex items-center gap-2 rounded-full px-3 py-1 text-xs ${theme === "light"
              ...
              <h2 className={`font-satoshi mt-5 text-4xl md:text-6xl font-bold tracking-tighter leading-[1.05] ${theme === "light" ? "text-gray-900" : ""
                }`}>
                Ready to eliminate
                <br />
                <span className="gradient-text">the queue?</span>
              </h2>
              <p className={`mt-5 text-lg max-w-lg ${theme === "light" ? "text-gray-700" : "text-zinc-300"
                }`}>
                Bring Order to Your Organization with WaitLess — Completely Free and Worth Trying.
            ...
            <form
              ...
              className={`rounded-2xl pt-2 pb-5 px-5 md:px-6 md:pt-3 md:pb-6 relative overflow-hidden transition-all duration-300 ${theme === "light"
